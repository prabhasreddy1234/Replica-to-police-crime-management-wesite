...
<!-- <ul class="nav">
  ...
  <li class="navele" style="width: 70%;color: red;"><center><marquee behavior="" direction="left" width="90%">Cyber crime department</marquee></center></li>
    ...
    <div class="box" style="border:solid 2px;border-radius:10px;">
    <div class="wrapper">
        <h2>Sign Up</h2>
        <p style="color:rgb(245,118,118);">REGISTER IF YOU DO NOT ALREADY HAVE AN ACCOUNT!!</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group" style="coloe:white;">
